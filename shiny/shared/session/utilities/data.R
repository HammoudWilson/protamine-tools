...
#     scores_wrk <- scores[getIncludedAutosomeBins(bins)] # only use good autosomal bins to analyze score distributions
...
# # load and format genome bins and read counts (from atac/collate action)
...
# }
# getIncludedAutosomeBins <- function(bins){
