#----------------------------------------------------------------------
# server components for the scoreSummary appStep module
#----------------------------------------------------------------------

#----------------------------------------------------------------------
# BEGIN MODULE SERVER
#----------------------------------------------------------------------
scoreSummaryServer <- function(id, options, bookmark, locks) { 
...
sampleDistributionPlot <- staticPlotBoxServer(
    ...
    create = function() {
        ...
        plotDistributions(
            ...
            metadata    = getSampleMetadata(sourceId, input$scoreType, samples),
...
stageTypeDistributionPlot <- staticPlotBoxServer(
    ...
    create = function() {
        ...
        plotDistributions(
            ...
            scoreType   = getScoreType(input$scoreType), 
            metadata    = getStageTypeMetadata(sourceId, input$scoreType, samples),
...
deltaDistributionPlot <- staticPlotBoxServer(
    ...
    create = function() {
        ...
        plotDistributions(
            ...
            scoreType   = getScoreType(input$scoreType), 
            metadata    = getStageTypeDeltaMetadata(sourceId, input$scoreType, cleanDist = TRUE),
